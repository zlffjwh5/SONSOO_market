      ...
      <div class="row justify-content-center">
          <div class="col-xl-8 ftco-animate">
            ...
            <div class="form-group">
              	<img src="/image/notice/<c:out value='${notice.thumbnail}'/>" class="img" style="height: 100px; width: 100px;">
              </div>
            </div>
              
              <div class="col-md-12">
              <div class="form-group">
                <label><b>제목 :</b></label><p><c:out value="${notice.title}"/></p>
              </div>
              </div>
              
              <div class="col-md-12">
              <div class="form-group">
                <label><b>요약 내용 :</b></label><p><c:out value="${notice.summary}"/></p>
              </div>
              </div>
              
              <div class="col-md-12">
              <div class="form-group">
                <label><b>상세 설명 :</b></label><p><c:out value="${notice.content}"/></p>
              </div>
              </div>
