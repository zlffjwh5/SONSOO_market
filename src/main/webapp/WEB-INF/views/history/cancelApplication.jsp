...
<html lang="en">
<head>
<title>구매취소 페이지</title>
<script type="text/javascript" src="https://code.jquery.com/jquery-1.12.4.min.js" ></script>
<script>
$(document).ready(function(){
	$('#select').change(function(){
		var refundMeans = $("option:selected", this).val();
		$('#refundMeans').val(refundMeans);
	});	
});
		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-0 bread">구매취소 신청</h1>
					<p class="breadcrumbs">
			...
			<div class="row">
				<div class="col-md-12 ftco-animate">
					...
					<div class="billing-form bg-light p-3 p-md-5">
						<h3 class="mb-4 billing-heading">취소 사유</h3>
							<div class="row align-items-end">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" name="refundMeans" id="refundMeans" class="form-control" placeholder="취소 사유를 입력 해 주세요.">
									</div>
								</div>
