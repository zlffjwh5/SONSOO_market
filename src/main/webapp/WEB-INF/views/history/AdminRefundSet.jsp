...
<body>
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<h1 class="mb-0 bread">ADMIN 환불 관리</h1>
					<p class="breadcrumbs">
			...
			<div class="row">
				<div class="col-md-12 ftco-animate">
					<table class="table">
						...
						<tbody>
							<c:forEach var="RefundStatus" items="${RefundStatus }" >
								<form action="changeRefundStatus" method="post">
									<tr class="text-center" id="p_list">
										<td class="product-name">
											<p>${RefundStatus.o_number }</p>
											<input name="o_number" value="${RefundStatus.o_number }" type="hidden">
											<h3>${RefundStatus.p_id }</h3>
											<input name="p_id" value="${RefundStatus.p_id }" type="hidden">
											<input name="status" value="7" type="hidden">
										</td>
	
										<td class="price">${RefundStatus.id }</td>
	
										<td class="price"><fmt:formatDate value="${RefundStatus.requestDate}" pattern="yyyy-MM-dd [E] a hh:mm:ss"/></td>
										
										<td>${RefundStatus.refundSystem }</td>
										
										<td>${RefundStatus.refundMeans }</td>
										
										<td><input class="btn btn-primary px-2 btn-block" onclick="refund()" type="submit" value="환불처리"></td>
									</tr>
									<!-- END TR-->
								</form>
							</c:forEach>
	...
	<form id='actionForm' action="/history/AdminRefundSet" method='get'>
