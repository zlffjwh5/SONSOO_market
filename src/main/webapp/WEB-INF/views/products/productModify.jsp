...
<!-- <script>
	function productDelete(){
		...
		if(confirm("상품을 삭제하시겠습니까?")){			
			location.href="/products/productDelete?p_id="+p_id;
		}else{
			return false;
		}
	}
	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
				<h1 class="mb-0 bread">MODIFY PRODUCT</h1>
			</div>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-xl-8 ftco-animate">
			<form action="/products/productModify" method="post"
				  enctype="multipart/form-data" class="billing-form bg-light p-3 p-md-5">
				<h3 class="mb-4 billing-heading">상품 수정</h3>
				<div class="row align-items-end">
					<div class="w-100"></div>
					<div class="col-md-6">
						<div class="form-group">
							<label for="firstname">상품Id</label>
							<input name="p_id" id="p_id" type="text" value="${product.p_id}" class="form-control" readonly>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="select-wrap">
								...
								<c:forEach var="category" items="${categoryList}">
									<option value="${category}"
										<c:if test="${product.category==category}"><c:out value="selected"/>
										</c:if>>${category}
									</option>
								</c:forEach>
								</select>
					...
					<%-- <div class="input-group col-md-6 d-flex mb-3">
						...
						<input type="text" id="stock" name="stock" class="form-control input-number" value="${product.stock}" min="0" max="100">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<textarea name="script" id="script" rows="6" cols="20" class="form-control">${product.script}</textarea>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
                ...
                <div class="w-100"></div>
                <div class="col-md-12">
                	<button data-oper='modify' onclick="return validate();" class="btn btn-primary py-1 px-2">수정하기</button> 
                	<!-- <button onclick="productDelete()" class="btn btn-primary py-1 px-2">삭제하기</button> -->
                	<!-- <button data-oper='delete' onclick="return productDelete();" class="btn btn-primary py-1 px-2">삭제하기</button> -->
                	<a href="/products/productDelete?p_id=${product.p_id}&id=${memberId}" onclick="return productDelete();" class="btn py-1 px-3 btn-primary">삭제하기</a>
                	<%-- <button data-oper='delete' onclick="/products/productDelete?p_id=${product.p_id}" class="btn btn-primary py-1 px-2">삭제하기</button> --%>
