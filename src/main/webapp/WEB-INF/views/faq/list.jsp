	...
	<div class="container">
    			...
    			<input type="hidden" name='id' id="id" value='<c:out value="${id}"/>'>
    				...
    				<table class="table">
						    ...
						    <c:forEach var="nvo" items="${faqList}">
						    <tbody>
						      <tr class="text-center">
    		...
    		<a href="/faq/write" id="block" class="btn btn-primary" style="margin-top:40px; margin-bottom:40px; margin-left:1000px;">작성</a>
